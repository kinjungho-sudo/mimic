      ...
      return (
        <div>
          ...
          {[
            {
              q: 'MIMIC이 뭔가요?',
              a: 'Chrome 확장 프로그램으로 업무 화면을 녹화해 인터랙티브 매뉴얼을 자동 생성하는 서비스입니다. 클릭 동작이 자동 캡처되어 단계별 스크린샷과 설명이 만들어지고, 링크로 공유하거나 Guide Me 오버레이로 실제 페이지에서 단계별 안내를 제공합니다.',
            },
            {
            ...
            {
              q: 'Guide Me는 어떻게 사용하나요?',
              a: '매뉴얼에 원본 페이지 URL이 저장되어 있으면 상단 "Guide Me" 버튼이 활성화됩니다. 클릭하면 새 탭에서 원본 페이지가 열리면서 오버레이가 자동 시작됩니다. → 다음, ← 이전, Esc 닫기 키보드도 지원합니다.',
            },
            {
            ...
            {
              q: '자체 서비스에 Guide Me를 삽입할 수 있나요?',
              a: '가능합니다. 페이지에 SDK 스크립트를 추가하거나 URL에 ?mimic_guide=TOKEN 파라미터를 붙이면 Guide Me가 자동 시작됩니다.',
            },
            {
