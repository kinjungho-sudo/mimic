    ...
    case 'intro':
      return (
        <div>
          ...
          {p('클릭 한 번 한 번이 자동으로 캡처되어 단계별 스크린샷과 설명이 만들어집니다. 완성된 매뉴얼은 링크와 문서로 공유하고, 필요하면 연습 가이드나 확장 프로그램 기반 라이브 가이드로 실행을 안내할 수 있습니다.')}
          {h3('MIMIC으로 할 수 있는 것')}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '16px', margin: '0 0 24px' }}>
            {[
              ...
              },
              {
                ...
                color: '#EEF2FF',
                border: '#a5b4fc',
                features: ['매뉴얼 생성 한도 확대', 'PDF/PPTX/Word 내보내기', '비밀번호 보호', '연습 가이드 + 라이브 가이드 베타'],
                highlight: true,
              },
              {
                name: 'Team',
      ...
      return (
        <div>
          ...
          {[
            {
              q: 'MIMIC이 뭔가요?',
              a: 'Chrome 확장 프로그램으로 업무 화면을 녹화해 SOP와 인터랙티브 매뉴얼을 자동 생성하는 서비스입니다. 클릭 동작이 자동 캡처되어 단계별 스크린샷과 설명이 만들어지고, 링크·문서·연습 가이드로 공유할 수 있습니다. 조건이 맞으면 라이브 가이드로 실제 페이지 위 안내도 사용할 수 있습니다.',
            },
            {
            ...
            },
            {
              ...
              a: '무료는 일 3회 매뉴얼 생성, 기본 공유, PDF 내보내기를 지원합니다. Pro는 생성 한도 확대, PDF/PPTX/Word 내보내기, 비밀번호 보호, 연습 가이드와 라이브 가이드 베타를 포함할 예정입니다. 가격 문의는 support@mimic.so로 연락해주세요.',
            },
            {
              q: '문의는 어떻게 하나요?',
