      ...
      <main className="settings-main" style={{ flex: 1, padding: '32px 40px', maxWidth: '720px' }}>
        ...
        <Section title="Desktop Companion">
          <div style={{ padding: '18px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '18px' }}>
            ...
            <Link href="/download/desktop?source=settings&reason=reinstall" style={{ padding: '9px 16px', borderRadius: '9px', fontSize: '13px', fontWeight: 700, background: 'linear-gradient(135deg, #3730a3, #6d28d9)', color: 'white', textDecoration: 'none', flexShrink: 0, boxShadow: '0 2px 8px rgba(55,48,163,0.25)' }}>
              상태 확인
            </Link>
          </div>
        </Section>
