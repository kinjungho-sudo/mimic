...
export const metadata: Metadata = {
  title: '이용약관',
  description: '포리 서비스 이용 시 적용되는 약관과 규정을 안내합니다.',
};
    ...
    <div style={{ minHeight: '100vh', background: '#FAFAFA', fontFamily: "'Pretendard', -apple-system, sans-serif" }}>
      ...
      <main style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        {[
          {
            title: '제1조 (목적)',
            body: '이 약관은 코마인드웍스(이하 "회사")가 제공하는 포리 서비스(이하 "서비스")의 이용과 관련하여 회사와 이용자 간의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.',
          },
          {
            title: '제2조 (정의)',
            body: '"서비스"란 회사가 제공하는 AI 인터랙티브 매뉴얼 제작 플랫폼 포리 및 관련 제반 서비스를 의미합니다. "이용자"란 이 약관에 따라 회사가 제공하는 서비스를 받는 회원 및 비회원을 말합니다. "회원"이란 회사에 개인정보를 제공하여 회원 등록을 한 자로서, 회사의 정보를 지속적으로 제공받으며 서비스를 계속적으로 이용할 수 있는 자를 말합니다.',
          },
          {
          ...
          {
            title: '제4조 (서비스의 제공)',
            body: '회사는 다음과 같은 서비스를 제공합니다. (1) AI 기반 인터랙티브 매뉴얼 자동 생성 서비스, (2) Chrome 확장 프로그램(포리 Recorder)을 통한 화면 캡처 및 매뉴얼 제작 서비스, (3) 제작된 매뉴얼의 공유 및 플레이어 서비스, (4) 기타 회사가 추가 개발하거나 다른 회사와의 제휴 계약 등을 통해 이용자에게 제공하는 일체의 서비스.',
          },
          {
            title: '제5조 (이용요금)',
