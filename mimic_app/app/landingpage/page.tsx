...
const features = [
  {
    ...
    title: '연습 가이드 + Live Guide',
    body: '공유받은 사람은 설치 없이 캡처 화면 위에서 먼저 연습할 수 있습니다. 확장 프로그램이 연결된 환경에서는 실제 페이지 위 안내로 업무를 이어갈 수 있어요.',
    comingSoon: false,
  },
  {
    icon: (
...
function HeroDemo() {
  ...
  const phases = [
    ...
    { label: 'Live Guide', title: '최종 목적지까지 옆에서 안내', body: '사용자는 실제 흐름을 따라가며 클릭 위치와 입력할 텍스트까지 차근차근 확인합니다.' },
  ];
...
const SHOWCASES = [
  ...
  },
  {
    ...
    eyebrow: 'LIVE GUIDE',
    title: '매뉴얼을 실행 순간까지\n화면 위에서 이어주세요',
    desc: '먼저 연습 가이드로 캡처 화면 위에서 안전하게 따라 해보고, 확장 프로그램이 연결된 환경에서는 실제 페이지 위 안내로 업무를 이어갈 수 있습니다. 문서로 정리한 지식이 실제 행동까지 이어집니다.',
    bullets: [
      '공유 링크에서는 설치 없는 연습 가이드 제공',
      '확장 연결 시 실제 페이지 위 Live Guide 실행',
      ...
      <div style={{ maxWidth: '1180px', margin: '0 auto', padding: '0 32px', position: 'relative', zIndex: 1 }}>
        <div className="simulator-grid">
            <div className="simulator-copy">
              ...
              <h2>Live Guide가 실제 화면 위에서 어떻게 움직이는지 보여줍니다</h2>
              <p>
          ...
          <div className="pricing-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px', maxWidth: '1180px', margin: '0 auto' }}>
            {([
              ...
              },
              {
                ...
                features: ['Basic 플랜 모든 기능', 'AI 다듬기 무제한', 'AI 상세 설명 생성', '연습 가이드 + Live Guide', 'AI 음성 편집', '5GB 저장 공간'],
                cta: '출시 알림 받기',
              },
              {
