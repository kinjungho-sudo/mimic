...
const simulatorDemos: SimulatorStep[] = [
  {
    ...
    screen: svgDataUri(`
      <svg xmlns="http://www.w3.org/2000/svg" width="1120" height="680" viewBox="0 0 1120 680">
        ...
        <rect x="116" y="288" width="166" height="42" rx="12" fill="#007C72"/>
        <text x="142" y="315" font-family="Inter, Arial" font-size="14" font-weight="850" fill="#E8FFF7">Members</text>
        ...
        <circle cx="402" cy="309" r="18" fill="#E8FFF7"/>
        <text x="395" y="315" font-family="Inter, Arial" font-size="16" font-weight="850" fill="#007C72">J</text>
        ...
        <rect x="742" y="178" width="222" height="58" rx="16" fill="#009B8E"/>
        <text x="801" y="213" font-family="Inter, Arial" font-size="16" font-weight="900" fill="white">멤버 초대</text>
        <rect x="742" y="178" width="222" height="58" rx="16" fill="none" stroke="#8DD63F" stroke-width="0">
        ...
        <circle cx="853" cy="207" r="42" fill="none" stroke="#8DD63F" stroke-width="0" opacity=".45">
        ...
        <rect x="360" y="478" width="278" height="62" rx="18" fill="#E8FFF7" stroke="#DDE7E4"/>
        <text x="392" y="515" font-family="Inter, Arial" font-size="15" font-weight="850" fill="#009B8E">Live Guide step 2 / 5</text>
        <text x="392" y="536" font-family="Inter, Arial" font-size="12" fill="#12B886">다음 목표: 초대 화면 열기</text>
      </svg>
    `),
    hotspotX: 76.2,
    hotspotY: 30.4,
  ...
  },
  {
    ...
    screen: svgDataUri(`
      <svg xmlns="http://www.w3.org/2000/svg" width="1120" height="680" viewBox="0 0 1120 680">
        ...
        <rect x="130" y="432" width="160" height="52" rx="14" fill="#E8FFF7" stroke="#12B886"/>
        <text x="180" y="464" font-family="Inter, Arial" font-size="15" font-weight="800" fill="#009B8E">Editor</text>
        ...
        <rect x="486" y="510" width="166" height="54" rx="16" fill="#009B8E"/>
        ...
        <text x="794" y="184" font-family="Inter, Arial" font-size="14" font-weight="900" fill="#8DD63F">LIVE GUIDE BETA</text>
        ...
        <text x="820" y="304" font-family="Inter, Arial" font-size="13" fill="#E8FFF7">이메일을 자동 입력 중</text>
        ...
        <rect x="794" y="410" width="198" height="42" rx="12" fill="#007C72"/>
...
function HeroDemo() {
  ...
  return (
    <div ref={rootRef} className="hero-flow-preview" style={{ position: 'relative', maxWidth: '1000px', margin: '0 auto' }}>
      <div style={{ borderRadius: '18px 18px 0 0', overflow: 'hidden', boxShadow: '0 24px 70px -12px rgba(0,155,142,0.30), 0 40px 90px -30px rgba(0,0,0,0.45)', border: '1px solid rgba(141,214,63,0.18)', background: '#0F0F18' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '12px 18px', background: '#171720', borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
          ...
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', color: '#E8FFF7', fontSize: '11px', fontWeight: 800, letterSpacing: '0.08em', textTransform: 'uppercase' }}>
            <i style={{ width: '7px', height: '7px', borderRadius: '50%', background: '#8DD63F', boxShadow: '0 0 0 5px rgba(141,214,63,0.12)' }} />
            Live Guide
          </span>
        </div>

        <div style={{ minHeight: '470px', display: 'grid', gridTemplateColumns: '0.92fr 1.08fr', background: 'linear-gradient(135deg,#111827 0%,#0b0b13 58%,#102033 100%)', position: 'relative', overflow: 'hidden' }}>
          <div style={{ padding: '42px 42px 38px', textAlign: 'left', borderRight: '1px solid rgba(255,255,255,0.07)' }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '7px 11px', borderRadius: '999px', background: 'rgba(18,184,134,0.18)', border: '1px solid rgba(141,214,63,0.24)', color: '#DDE7E4', fontSize: '11px', fontWeight: 850, letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '24px' }}>{current.label}</div>
            ...
            <div style={{ display: 'grid', gap: '10px', marginTop: '36px' }}>
              {phases.map((item, index) => {
                ...
                return (
                  <div key={item.label} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '13px 14px', borderRadius: '12px', border: '1px solid ' + (isActive ? 'rgba(141,214,63,0.44)' : 'rgba(255,255,255,0.08)'), background: isActive ? 'rgba(18,184,134,0.20)' : 'rgba(255,255,255,0.035)', transition: 'background .3s ease, border-color .3s ease' }}>
                    <span style={{ width: '24px', height: '24px', borderRadius: '8px', display: 'grid', placeItems: 'center', background: isActive ? '#12B886' : 'rgba(255,255,255,0.08)', color: isActive ? 'white' : 'rgba(255,255,255,0.44)', fontSize: '11px', fontWeight: 850 }}>{index + 1}</span>
          ...
          <div style={{ padding: '38px', display: 'grid', alignContent: 'center', gap: '18px', position: 'relative' }}>
            <div style={{ display: 'grid', gap: '12px' }}>
              {[
                ...
                <div key={step.title} style={{ display: 'grid', gridTemplateColumns: '42px 1fr auto', alignItems: 'center', gap: '14px', padding: '16px', borderRadius: '14px', background: step.state ? 'rgba(255,255,255,0.96)' : 'rgba(255,255,255,0.72)', border: '1px solid ' + (index === phase ? '#8DD63F' : 'rgba(255,255,255,0.54)'), boxShadow: index === phase ? '0 18px 42px rgba(18,184,134,0.24)' : '0 8px 24px rgba(0,0,0,0.12)', transition: 'all .35s ease' }}>
                  <span style={{ width: '42px', height: '42px', borderRadius: '12px', display: 'grid', placeItems: 'center', background: step.state ? 'linear-gradient(135deg,#009B8E,#12B886)' : '#E8FFF7', color: step.state ? 'white' : '#6b7280', fontWeight: 900 }}>{String(index + 1).padStart(2, '0')}</span>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 180px', gap: '14px', alignItems: 'stretch' }}>
              <div style={{ padding: '18px', borderRadius: '16px', background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.10)', color: 'white', textAlign: 'left' }}>
                <div style={{ fontSize: '11px', color: '#E8FFF7', fontWeight: 850, letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '10px' }}>Guide overlay</div>
                <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '10px 12px', borderRadius: '12px', background: 'white', color: '#111827', fontSize: '13px', fontWeight: 800, boxShadow: '0 18px 38px rgba(0,0,0,0.24)' }}>
                  <span style={{ width: '22px', height: '22px', borderRadius: '50%', display: 'grid', placeItems: 'center', background: '#12B886', color: 'white', fontSize: '12px' }}>{phase + 1}</span>
              ...
              <div style={{ padding: '18px', borderRadius: '16px', background: '#111827', border: '1px solid rgba(255,255,255,0.10)', color: 'white', textAlign: 'left' }}>
                <div style={{ fontSize: '11px', color: '#8DD63F', fontWeight: 850, letterSpacing: '0.1em', textTransform: 'uppercase' }}>Result</div>
                <div style={{ marginTop: '34px', height: '7px', borderRadius: '999px', background: 'rgba(255,255,255,0.12)', overflow: 'hidden' }}>
                  <div style={{ width: String(((phase + 1) / 3) * 100) + '%', height: '100%', borderRadius: '999px', background: 'linear-gradient(90deg,#10b981,#8DD63F)', transition: 'width .35s ease' }} />
                </div>
...
function Scene0({ tick }: { tick: number }) {
  ...
  const MANUALS = [
    ...
    { title: 'n8n에서 이메일 워크플로우', sub: 'n8n.cloud · 6단계', color: '#E8FFF7', icon: '⚙️' },
    ...
    <div style={{ width: '100%', height: '100%', background: '#fff', display: 'grid', gridTemplateColumns: '150px 1fr', position: 'relative' }}>
      ...
      <div style={{ background: '#FAFAFB', borderRight: '1px solid #EEE', padding: '14px 10px', display: 'flex', flexDirection: 'column', gap: '2px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '12px' }}>
          <div style={{ width: '20px', height: '20px', borderRadius: '6px', background: 'linear-gradient(135deg,#12B886,#009B8E)', display: 'grid', placeItems: 'center', color: '#fff', fontWeight: 800, fontSize: '11px' }}>P</div>
        ...
        {['전체 19','미분류 18'].map(t=>(
          <div key={t} style={{ padding: '5px 8px', borderRadius: '6px', fontSize: '10px', color: '#4B5563', background: t.startsWith('전체')?'#E8FFF7':'transparent', fontWeight: t.startsWith('전체')?600:400 }}>{t}</div>
        ))}
        ...
        {FOLDERS.map(f=>(
          <div key={f} style={{ padding: '4px 8px', borderRadius: '6px', fontSize: '10px', color: '#6B7280', display: 'flex', alignItems: 'center', gap: '6px' }}>
            <span style={{ width: '5px', height: '5px', borderRadius: '2px', background: '#E8FFF7' }} />{f}
          </div>
        ))}
      </div>
      {/* 본문 */}
...
function Scene1({ tick }: { tick: number }) {
  ...
  return (
    <div style={{ width: '100%', height: '100%', background: '#0D0D14', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: '16px' }}>
      <div style={{ position: 'absolute', width: '300px', height: '300px', borderRadius: '50%', background: isStart ? 'radial-gradient(circle, rgba(16,185,129,0.2) 0%, transparent 70%)' : 'radial-gradient(circle, rgba(18,184,134,0.25) 0%, transparent 70%)', filter: 'blur(20px)', pointerEvents: 'none' }} />
      <div key={count} style={{ fontSize: isStart ? '72px' : '96px', fontWeight: 900, letterSpacing: isStart ? '-0.02em' : '-0.04em', color: isStart ? '#10B981' : 'white', textShadow: isStart ? '0 0 40px rgba(16,185,129,0.6)' : '0 0 40px rgba(18,184,134,0.5)', animation: 'countPop 0.25s cubic-bezier(0.34,1.8,0.64,1) both', lineHeight: 1 }}>
        {count}
      </div>
  ...
  return (
    <div style={{ width: '100%', height: '100%', position: 'relative', background: 'linear-gradient(135deg,#2a2745,#1a1830)', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', top: '14px', right: '14px', bottom: '14px', width: '172px', background: '#fff', borderRadius: '12px', boxShadow: '0 18px 48px rgba(0,0,0,0.45), 0 0 0 1px rgba(255,255,255,0.08)', display: 'flex', flexDirection: 'column', overflow: 'hidden', zIndex: 20 }}>
        ...
        <div style={{ background: 'linear-gradient(135deg,#12B886,#009B8E)', padding: '9px 11px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '8px 11px', borderBottom: '1px solid #F3F4F6' }}>
          ...
          <span style={{ fontSize: '9px', fontWeight: 700, color: '#12B886', background: '#E8FFF7', padding: '2px 7px', borderRadius: '999px' }}>{steps} steps</span>
        </div>
        ...
        <div style={{ flex: 1, overflow: 'hidden', padding: '0 9px', display: 'flex', flexDirection: 'column', gap: '6px' }}>
          {steps === 0 && <div style={{ fontSize: '8.5px', color: '#E8FFF7', textAlign: 'center', padding: '14px 6px', lineHeight: 1.5 }}>화면을 클릭하면<br/>자동으로 캡처됩니다</div>}
          {REC_STEPS.slice(0, steps).map((s, i) => (
            <div key={i} style={{ border: '1px solid #E5E7EB', borderRadius: '8px', overflow: 'hidden', animation: 'sceneIn 0.4s cubic-bezier(0.34,1.4,0.64,1) both' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '5px', padding: '5px 7px', background: '#FAFAFB' }}>
                <span style={{ width: '14px', height: '14px', borderRadius: '4px', background: '#12B886', color: '#fff', fontSize: '8px', fontWeight: 700, display: 'grid', placeItems: 'center' }}>{i+1}</span>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '8px 10px', borderTop: '1px solid #F3F4F6' }}>
          ...
          <div style={{ padding: '5px 12px', borderRadius: '6px', background: 'linear-gradient(135deg,#009B8E,#12B886)', color: '#fff', fontSize: '9.5px', fontWeight: 700 }}>✓ 완료</div>
        </div>
      </div>
    </div>
  );
...
function Scene3({ tick }: { tick: number }) {
  return (
    <div style={{ width: '100%', height: '100%', position: 'relative', background: 'linear-gradient(135deg,#2a2745,#1a1830)', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', top: '14px', right: '14px', bottom: '14px', width: '172px', background: '#fff', borderRadius: '12px', boxShadow: '0 18px 48px rgba(0,0,0,0.45), 0 0 0 1px rgba(255,255,255,0.08)', display: 'flex', flexDirection: 'column', overflow: 'hidden', zIndex: 20 }}>
        <div style={{ background: 'linear-gradient(135deg,#12B886,#009B8E)', padding: '9px 11px', display: 'flex', alignItems: 'center', gap: '6px' }}>
          <div style={{ width: '18px', height: '18px', borderRadius: '5px', background: 'rgba(255,255,255,0.22)', display: 'grid', placeItems: 'center', color: '#fff', fontWeight: 800, fontSize: '10px' }}>P</div>
          <span style={{ fontSize: '10.5px', fontWeight: 800, color: '#fff' }}>{BRAND_COPY.extensionDisplayName}</span>
        </div>
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '12px', padding: '0 14px' }}>
          <div style={{ width: '38px', height: '38px', borderRadius: '50%', border: '3px solid #E8FFF7', borderTopColor: '#12B886', animation: 'spin 0.8s linear infinite' }} />
    ...
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '9px 14px', borderBottom: '1px solid #EEE', background: '#fff' }}>
      ...
      <div style={{ display: 'flex', gap: '4px' }}>
        {[['웹 문서','doc'],['Live Guide Beta','guide'],['슬라이드','slide']].map(([label, key]) => (
          <div key={key} style={{ padding: '5px 11px', borderRadius: '7px', fontSize: '10px', fontWeight: 600, background: mode === key ? '#E8FFF7' : 'transparent', color: mode === key ? '#12B886' : '#9CA3AF', border: mode === key ? '1px solid rgba(18,184,134,0.3)' : '1px solid transparent' }}>{label}</div>
        ))}
      </div>
    </div>
  );
  ...
  return (
    <div style={{ width: '100%', height: '100%', background: '#F4F4F7', display: 'grid', gridTemplateColumns: '146px 1fr', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ background: '#fff', borderRight: '1px solid #EEE', padding: '11px 8px', overflow: 'hidden' }}>
        ...
        {GUIDE_STEPS.map((s, i) => (
          <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '5px', padding: '5px 6px', borderRadius: '6px', marginBottom: '2px', background: i === 0 ? '#E8FFF7' : 'transparent' }}>
            <span style={{ width: '14px', height: '14px', borderRadius: '4px', background: i === 0 ? '#12B886' : '#E5E7EB', color: i === 0 ? '#fff' : '#9CA3AF', fontSize: '7.5px', fontWeight: 700, display: 'grid', placeItems: 'center', flexShrink: 0 }}>{i + 1}</span>
            <span style={{ fontSize: '8.5px', fontWeight: i === 0 ? 600 : 400, color: i === 0 ? '#007C72' : '#6B7280', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{s.title}</span>
          </div>
        ))}
      </div>
      {/* 우측 — 에디터 */}
      <div style={{ position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '8px 12px', borderBottom: '1px solid #EEE', background: '#fff', flexShrink: 0 }}>
          ...
          <div style={{ display: 'flex', gap: '5px' }}>
            ...
            <span style={{ fontSize: '9px', color: '#fff', padding: '4px 10px', borderRadius: '6px', background: 'linear-gradient(135deg,#12B886,#009B8E)', fontWeight: 700 }}>편집 완료</span>
          </div>
        </div>
        {/* 스크롤 본문 */}
        <div style={{ flex: 1, overflow: 'hidden', position: 'relative' }}>
          <div style={{ padding: '14px 18px', transform: `translateY(${-scrollY}px)`, transition: 'transform 0.12s linear' }}>
            ...
            {GUIDE_STEPS.slice(0, 3).map((s, i) => {
              const active = i === 0;
              return (
                <div key={i} style={{ background: '#fff', borderRadius: '12px', border: active ? '1.5px solid #E8FFF7' : '1px solid #EEE', boxShadow: active ? '0 6px 20px rgba(18,184,134,0.13)' : '0 1px 3px rgba(0,0,0,0.04)', padding: '11px 13px', marginBottom: '11px', position: 'relative' }}>
                  {/* 카드 헤더 — 드래그 핸들 + 번호 + 제목 + 편집 아이콘 */}
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '6px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '7px' }}>
                      <span style={{ fontSize: '11px', color: '#D1D5DB' }}>⠿</span>
                      <span style={{ width: '20px', height: '20px', borderRadius: '6px', background: '#12B886', color: '#fff', fontSize: '9px', fontWeight: 800, display: 'grid', placeItems: 'center' }}>{s.num}</span>
                  ...
                  {active && (
                    <div style={{ display: 'flex', alignItems: 'center', gap: '9px', padding: '4px 9px', background: '#F9FAFB', borderRadius: '6px', marginBottom: '7px', border: '1px solid #EEE' }}>
                      ...
                      <span style={{ marginLeft: 'auto', fontSize: '8.5px', color: '#12B886', fontWeight: 700 }}>✨ AI 완성</span>
                    </div>
                  )}
                  {/* 설명 */}
      ...
      <div style={{ position: 'absolute', top: '26px', left: '50%', transform: 'translateX(-50%)', width: '326px', background: '#fff', borderRadius: '16px', boxShadow: '0 24px 60px rgba(0,0,0,0.3)', overflow: 'hidden', animation: 'sceneIn 0.4s cubic-bezier(0.34,1.4,0.64,1) both', zIndex: 10 }}>
        ...
        <div style={{ padding: '14px 18px' }}>
          ...
          <div style={{ display: 'flex', borderRadius: '8px', overflow: 'hidden', border: '1.5px solid #E5E7EB', marginBottom: '11px' }}>
            ...
            <div style={{ padding: '8px 13px', background: copied ? '#10B981' : 'linear-gradient(135deg,#12B886,#009B8E)', color: '#fff', fontSize: '10px', fontWeight: 700, transition: 'background 0.3s', whiteSpace: 'nowrap' }}>{copied ? '✓ 복사됨' : '🔗 링크 복사'}</div>
          </div>
          {/* 공개 범위 + 비밀번호 */}
  ...
  return (
    <div style={{ width: '100%', height: '100%', background: '#fff', display: 'flex', flexDirection: 'column', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ flex: 1, display: 'flex', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ width: '152px', borderLeft: '1px solid #EEE', background: '#FAFAFB', display: 'flex', flexDirection: 'column', flexShrink: 0, zIndex: 12 }}>
          <div style={{ padding: '11px 11px 8px', borderBottom: '1px solid #EEE' }}>
            <div style={{ fontSize: '9px', fontWeight: 800, color: '#12B886', display: 'flex', alignItems: 'center', gap: '4px' }}>● LIVE GUIDE BETA</div>
          ...
          <div style={{ flex: 1, overflow: 'hidden', padding: '8px' }}>
            {GUIDE_STEPS.map((s, i) => {
              ...
              return (
                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '6px', padding: '5px 6px', borderRadius: '6px', marginBottom: '2px', background: cur ? '#E8FFF7' : 'transparent' }}>
                  <span style={{ width: '14px', height: '14px', borderRadius: '50%', background: done ? '#10B981' : cur ? '#12B886' : '#E5E7EB', color: '#fff', fontSize: '7px', fontWeight: 700, display: 'grid', placeItems: 'center', flexShrink: 0 }}>
                    {done ? '✓' : i + 1}
                  </span>
                  <span style={{ fontSize: '8px', fontWeight: cur ? 600 : 400, color: cur ? '#007C72' : done ? '#9CA3AF' : '#6B7280', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', textDecoration: done ? 'line-through' : 'none' }}>{s.title}</span>
                </div>
              );
            })}
          </div>
      ...
      <div style={{ position: 'absolute', bottom: '12px', left: 'calc(50% - 76px)', transform: 'translateX(-50%)', display: 'flex', alignItems: 'center', gap: '10px', padding: '6px 14px', borderRadius: '999px', background: '#fff', boxShadow: '0 6px 20px rgba(0,0,0,0.15)', border: '1px solid #EEE', zIndex: 13 }}>
        ...
        <span style={{ padding: '4px 12px', borderRadius: '6px', background: 'linear-gradient(135deg,#12B886,#009B8E)', fontSize: '9.5px', color: '#fff', fontWeight: 700 }}>다음 →</span>
      </div>
    </div>
  );
}
...
function ShowcaseMedia({ videoSrc, fallback }: { videoSrc: string; fallback: React.ReactNode }) {
  ...
  return (
    <div style={{ position: 'relative', borderRadius: '16px', overflow: 'hidden', border: '1px solid #E5E7EB', boxShadow: '0 24px 60px -16px rgba(0,155,142,0.18), 0 6px 20px rgba(17,24,39,0.06)', background: 'white' }}>
      {!ready && fallback}
      {hasVideo && (
        <video
    ...
    <div className="record-flash-demo" style={{ height: '340px', background: '#E9E9F0', position: 'relative', display: 'flex' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
        ...
        <div style={{ flex: 1, padding: '18px 22px', position: 'relative', background: 'white' }}>
          ...
          <div className="capture-toast" style={{ position: 'absolute', left: '22px', bottom: '18px', display: 'flex', alignItems: 'center', gap: '8px', padding: '8px 12px', borderRadius: '10px', background: '#111827', boxShadow: '0 10px 28px rgba(17,24,39,0.28)', color: 'white' }}>
            <span style={{ width: '22px', height: '22px', borderRadius: '7px', background: 'linear-gradient(135deg,#12B886,#009B8E)', display: 'grid', placeItems: 'center', fontSize: '12px', fontWeight: 800 }}>✓</span>
      ...
      <div style={{ width: '186px', background: 'white', borderLeft: '1px solid #E5E7EB', display: 'flex', flexDirection: 'column', flexShrink: 0 }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 12px', borderBottom: '1px solid #F3F4F6' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            <div style={{ width: '19px', height: '19px', borderRadius: '6px', background: 'linear-gradient(135deg,#12B886,#009B8E)', display: 'grid', placeItems: 'center', color: '#fff', fontWeight: 800, fontSize: '10px' }}>P</div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '7px 12px', borderBottom: '1px solid #F3F4F6' }}>
          ...
          <span style={{ fontSize: '9px', fontWeight: 700, color: '#12B886', background: '#E8FFF7', padding: '2px 7px', borderRadius: '999px' }}>3 steps</span>
        </div>
        <div style={{ fontSize: '8.5px', color: '#9CA3AF', fontWeight: 700, padding: '7px 12px 5px' }}>캡처된 스텝</div>
        <div style={{ flex: 1, overflow: 'hidden', padding: '0 9px', display: 'flex', flexDirection: 'column', gap: '6px' }}>
          {STEPS.map((s, i) => (
            <div key={i} className="record-step-card" style={{ animationDelay: `${i * 0.24}s`, border: `1px solid ${s.hl ? '#E8FFF7' : '#E5E7EB'}`, borderRadius: '8px', overflow: 'hidden', boxShadow: s.hl ? '0 2px 10px rgba(18,184,134,0.16)' : 'none' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '5px', padding: '4px 7px', background: '#FAFAFB' }}>
                <span style={{ width: '13px', height: '13px', borderRadius: '4px', background: '#12B886', color: '#fff', fontSize: '7.5px', fontWeight: 700, display: 'grid', placeItems: 'center' }}>{i + 1}</span>
                <span style={{ fontSize: '8px', fontWeight: 600, color: '#374151', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{s.label}</span>
              </div>
      ...
      <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '150px 1fr', minHeight: 0 }}>
        <div style={{ borderRight: '1px solid rgba(255,255,255,0.07)', padding: '12px 9px' }}>
          ...
          {['로그인 화면 열기', '공유 버튼 클릭', '권한 설정', '링크 복사'].map((s, i) => (
            <div key={i} style={{ padding: '6px 8px', borderRadius: '6px', marginBottom: '4px', background: i === 1 ? 'rgba(18,184,134,0.22)' : 'rgba(255,255,255,0.04)', border: `1px solid ${i === 1 ? 'rgba(18,184,134,0.45)' : 'rgba(255,255,255,0.06)'}`, fontSize: '9.5px', color: i === 1 ? 'white' : '#6B7280', fontWeight: i === 1 ? 600 : 400, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
              {i + 1}. {s}
            </div>
          ))}
        </div>
        <div style={{ padding: '12px 14px', position: 'relative' }}>
          ...
          <div style={{ display: 'inline-flex', gap: '3px', padding: '4px', borderRadius: '8px', background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', marginBottom: '10px' }}>
            {TOOLS.map((t, i) => (
              <span key={i} style={{ width: '22px', height: '22px', borderRadius: '5px', display: 'grid', placeItems: 'center', fontSize: '10px', color: i === 1 ? 'white' : '#9CA3AF', background: i === 1 ? '#12B886' : 'transparent' }}>{t}</span>
            ))}
          </div>
          ...
          {/* AI 다듬기 배지 */}
          <div style={{ position: 'absolute', bottom: '12px', left: '14px', display: 'inline-flex', alignItems: 'center', gap: '5px', padding: '6px 12px', borderRadius: '999px', background: 'rgba(18,184,134,0.15)', border: '1px solid rgba(18,184,134,0.4)', fontSize: '10px', color: '#E8FFF7', fontWeight: 600 }}>
            <svg width="10" height="10" viewBox="0 0 24 24" fill="#8DD63F"><path d="M12 2l2.4 7.4H22l-6.2 4.5 2.4 7.4L12 17l-6.2 4.3 2.4-7.4L2 9.4h7.6z"/></svg>
            AI 다듬기 적용됨
          </div>
        </div>
      </div>
    ...
    <div style={{ height: '340px', background: 'white', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, padding: '16px 20px', overflow: 'hidden' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px' }}>
          ...
          <span style={{ fontSize: '9.5px', fontWeight: 700, color: '#12B886', background: '#F7FFF8', border: '1px solid #DDE7E4', padding: '2px 8px', borderRadius: '999px' }}>AI 설명 초안</span>
        </div>
        {[
          ...
          <div key={i} style={{ display: 'flex', gap: '10px', padding: '11px 13px', borderRadius: '11px', border: '1px solid #EDEDED', marginBottom: '9px', background: 'white' }}>
            <div style={{ width: '24px', height: '24px', borderRadius: '7px', background: 'linear-gradient(135deg,#009B8E,#12B886)', display: 'grid', placeItems: 'center', flexShrink: 0 }}>
            ...
            <div style={{ minWidth: 0 }}>
              <div style={{ fontSize: '11.5px', fontWeight: 700, color: '#111827', marginBottom: '3px', display: 'flex', alignItems: 'center', gap: '6px' }}>
                {s.title}
                <span style={{ display: 'inline-flex', alignItems: 'center', gap: '3px', fontSize: '8.5px', fontWeight: 700, color: '#12B886' }}>
                  <svg width="8" height="8" viewBox="0 0 24 24" fill="#8DD63F"><path d="M12 2l2.4 7.4H22l-6.2 4.5 2.4 7.4L12 17l-6.2 4.3 2.4-7.4L2 9.4h7.6z"/></svg>
                  AI 생성
                </span>
              </div>
        ...
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', padding: '7px 13px', borderRadius: '999px', background: 'rgba(18,184,134,0.08)', border: '1px dashed rgba(18,184,134,0.35)', fontSize: '10px', color: '#12B886', fontWeight: 600 }}>
            <span style={{ display: 'inline-flex', gap: '2px' }}>
              {[0, 1, 2].map(i => <span key={i} style={{ width: '4px', height: '4px', borderRadius: '50%', background: '#12B886', animation: `dotBounce 1.2s ${i * 0.15}s ease-in-out infinite` }} />)}
            </span>
  ...
  return (
    <div style={{ height: '340px', background: 'white', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, display: 'flex', minHeight: 0 }}>
        ...
        <div style={{ width: '168px', background: '#0d0d14', display: 'flex', flexDirection: 'column', flexShrink: 0, borderLeft: '1px solid rgba(18,184,134,0.35)' }}>
          {/* 패널 헤더 */}
          <div style={{ background: 'linear-gradient(135deg,#009B8E,#12B886)', padding: '9px 12px' }}>
          ...
          <div style={{ flex: 1, padding: '10px 11px', display: 'flex', flexDirection: 'column', gap: '6px' }}>
            {GUIDE_STEPS_MOCK.map((s) => (
              <div key={s.num} style={{ display: 'flex', alignItems: 'center', gap: '7px', opacity: s.done || s.active ? 1 : 0.45 }}>
                <div style={{ width: '18px', height: '18px', borderRadius: '5px', flexShrink: 0, background: s.done ? '#12B886' : s.active ? 'rgba(18,184,134,0.25)' : 'rgba(255,255,255,0.06)', border: s.active ? '1.5px solid #12B886' : 'none', display: 'grid', placeItems: 'center' }}>
                  {s.done
                    ...
                    : <span style={{ fontSize: '6.5px', fontWeight: 700, color: s.active ? '#8DD63F' : '#6B7280' }}>{s.num}</span>}
                </div>
                <span style={{ fontSize: '9px', color: s.active ? 'white' : s.done ? '#8DD63F' : '#6B7280', fontWeight: s.active ? 700 : 400, lineHeight: 1.3 }}>{s.label}</span>
                {s.active && <span style={{ marginLeft: 'auto', width: '5px', height: '5px', borderRadius: '50%', background: '#8DD63F', flexShrink: 0, animation: 'rec-blink 1.2s infinite' }} />}
              </div>
            ))}
          </div>
          {/* 진행 바 */}
          <div style={{ padding: '9px 11px', borderTop: '1px solid rgba(255,255,255,0.07)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '5px' }}>
              ...
              <span style={{ fontSize: '8.5px', fontWeight: 700, color: '#8DD63F' }}>2 / 4</span>
            </div>
            <div style={{ height: '3px', background: 'rgba(255,255,255,0.1)', borderRadius: '999px' }}>
              <div style={{ width: '50%', height: '100%', background: 'linear-gradient(90deg,#12B886,#8DD63F)', borderRadius: '999px' }} />
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={{ flex: 1, padding: '16px 20px', position: 'relative' }}>
        ...
        <div style={{ background: 'white', borderRadius: '13px', border: '1px solid #EDEDED', padding: '14px 16px', marginBottom: '10px' }}>
          ...
          <div style={{ display: 'flex', borderRadius: '8px', overflow: 'hidden', border: '1.5px solid #E5E7EB' }}>
            ...
            <span style={{ padding: '8px 13px', background: 'linear-gradient(135deg,#009B8E,#12B886)', color: 'white', fontSize: '10px', fontWeight: 700, display: 'flex', alignItems: 'center' }}>링크 복사</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginTop: '8px' }}>
            <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="#12B886" strokeWidth="2"><rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V7a4 4 0 0 1 8 0v4"/></svg>
        ...
        <div style={{ background: 'white', borderRadius: '13px', border: '1px solid #EDEDED', padding: '12px 16px', display: 'flex', alignItems: 'center', gap: '12px' }}>
          <div style={{ width: '30px', height: '30px', borderRadius: '8px', background: 'linear-gradient(135deg,#009B8E,#12B886)', display: 'grid', placeItems: 'center', flexShrink: 0 }}>
          ...
          <div style={{ display: 'flex', gap: '4px', alignItems: 'center' }}>
            <span style={{ fontSize: '9px', fontWeight: 700, color: '#12B886', background: '#E8FFF7', padding: '2px 7px', borderRadius: '999px' }}>3명</span>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <section id="tour" style={{ padding: '96px 0 32px', background: 'white' }}>
      <div style={{ maxWidth: '1180px', margin: '0 auto', padding: '0 32px' }}>
        <RevealSection>
          <span style={{ display: 'block', textAlign: 'center', fontSize: '11px', color: '#007C72', fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase', marginBottom: '16px' }}>Product Tour</span>
              ...
              <div className={`showcase-row${i % 2 === 1 ? ' flip' : ''}`}>
                <div className="showcase-text" style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '18px' }}>
                    <span style={{ fontSize: '12px', fontWeight: 700, color: '#12B886', letterSpacing: '0.1em', textTransform: 'uppercase' }}>{sc.eyebrow}</span>
                    {sc.badge && (
                      <span style={{ fontSize: '10px', fontWeight: 700, color: 'white', background: 'linear-gradient(135deg,#009B8E,#12B886)', padding: '3px 9px', borderRadius: '999px', letterSpacing: '0.04em' }}>{sc.badge}</span>
                    )}
                  </div>
                  ...
                  <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                    {sc.bullets.map(b => (
                      <li key={b} style={{ display: 'flex', gap: '10px', alignItems: 'flex-start', fontSize: '14px', color: '#374151', padding: '6px 0' }}>
                        <span style={{ flexShrink: 0, marginTop: '3px', width: '17px', height: '17px', borderRadius: '5px', background: '#F7FFF8', display: 'grid', placeItems: 'center' }}>
                          <CheckIcon size={10} color="#12B886" />
                        </span>
                        {b}
                      </li>
                    ))}
...
export default function LandingPage() {
  ...
  return (
    <div className="landing-page" style={{ fontFamily: "'Pretendard', 'Pretendard Variable', -apple-system, BlinkMacSystemFont, 'Segoe UI', Inter, Roboto, sans-serif", color: '#111827', background: '#fff', WebkitFontSmoothing: 'antialiased', overflowX: 'clip' }}>
      ...
      <section className="landing-dark-section" style={{ padding: '128px 0', background: 'linear-gradient(180deg, #07070F 0%, #0d0d1c 100%)', overflow: 'hidden', position: 'relative' }}>
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', padding: '0 32px', textAlign: 'center', position: 'relative' }}>
          <RevealSection>
            <p style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '16px', fontSize: '11px', fontWeight: 700, letterSpacing: '0.18em', textTransform: 'uppercase', color: '#12B886', marginBottom: '36px' }}>
              <span style={{ flex: 1, maxWidth: '80px', height: '1px', background: 'linear-gradient(90deg, transparent, rgba(18,184,134,0.5))' }} />
              The Parro Way
              <span style={{ flex: 1, maxWidth: '80px', height: '1px', background: 'linear-gradient(90deg, rgba(18,184,134,0.5), transparent)' }} />
            </p>
            <h2 style={{ fontSize: 'clamp(38px, 6vw, 72px)', fontWeight: 800, lineHeight: 1.1, letterSpacing: '-0.04em', color: 'white', margin: '0 0 28px', wordBreak: 'keep-all' }}>
              절차를 기록하면<br />
              <span style={{ background: 'linear-gradient(135deg, #e0d7ff 0%, #E8FFF7 40%, #818cf8 100%)', WebkitBackgroundClip: 'text', backgroundClip: 'text', color: 'transparent' }}>
                실행까지 이어진다.
              </span>
            </h2>
            ...
            <div className="grid-3col how-steps" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '0', position: 'relative' }}>
              ...
              {[
                ...
                <div key={s.num} style={{ padding: '0 40px 0', position: 'relative', zIndex: 1, textAlign: 'center' }}>
                  <div style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '84px', height: '84px', borderRadius: '50%', background: 'linear-gradient(135deg, #009B8E 0%, #12B886 100%)', marginBottom: '28px', boxShadow: '0 0 0 8px rgba(18,184,134,0.08), 0 12px 28px rgba(0,155,142,0.32)', position: 'relative' }}>
                    {s.icon}
                    <span style={{ position: 'absolute', top: '-4px', right: '-4px', width: '24px', height: '24px', borderRadius: '50%', background: '#0D0D14', border: '2px solid #009B8E', display: 'grid', placeItems: 'center', fontSize: '9px', fontWeight: 800, color: '#E8FFF7' }}>{i + 1}</span>
                  </div>
            ...
            <div className="grid-2col" style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '16px' }}>
              {useCases.map(uc => (
                <div key={uc.tag}
                  ...
                  onMouseEnter={e => { const el = e.currentTarget as HTMLElement; el.style.borderColor = 'rgba(0,155,142,0.28)'; el.style.boxShadow = '0 16px 40px rgba(0,155,142,0.08)'; el.style.transform = 'translateY(-4px)'; }}
                ...
                >
                  <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: '3px', background: 'linear-gradient(90deg, #009B8E, #12B886)', opacity: 0, transition: 'opacity 0.25s' }} />
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
                    <div style={{ width: '48px', height: '48px', borderRadius: '14px', background: 'linear-gradient(135deg, #E8FFF7, #E8FFF7)', display: 'grid', placeItems: 'center', fontSize: '24px', flexShrink: 0 }}>{uc.emoji}</div>
                    <span style={{ fontSize: '11px', fontWeight: 700, color: '#007C72', background: '#E8FFF7', padding: '4px 12px', borderRadius: '999px', letterSpacing: '0.04em' }}>{uc.tag}</span>
                  </div>
            ...
            <div className="grid-3col" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '14px' }}>
              {features.map(f => (
                <div key={f.title}
                  ...
                  onMouseEnter={e => { const el = e.currentTarget as HTMLElement; el.style.borderColor = 'rgba(18,184,134,0.40)'; el.style.transform = 'translateY(-5px)'; el.style.boxShadow = '0 20px 48px rgba(0,0,0,0.5), 0 0 30px rgba(18,184,134,0.12)'; el.style.background = 'rgba(18,184,134,0.06)'; }}
                ...
                >
                  {f.comingSoon && (
                    <span style={{ position: 'absolute', top: '16px', right: '16px', fontSize: '9.5px', fontWeight: 700, color: '#E8FFF7', background: 'rgba(18,184,134,0.15)', padding: '3px 9px', borderRadius: '999px', border: '1px solid rgba(18,184,134,0.3)' }}>출시 예정</span>
                  )}
                  <div style={{ width: '46px', height: '46px', borderRadius: '13px', background: 'linear-gradient(135deg, #009B8E 0%, #12B886 100%)', display: 'grid', placeItems: 'center', marginBottom: '20px', boxShadow: '0 4px 16px rgba(0,155,142,0.40)' }}>
                    {f.icon}
                  </div>
          ...
          <div className="comparison-table" style={{ background: 'white', border: '1.5px solid #E5E7EB', borderRadius: '20px', overflow: 'hidden' }}>
            ...
            <div className="comparison-row" style={{ display: 'grid', gridTemplateColumns: '1fr repeat(3, 140px)', borderBottom: '1.5px solid #E5E7EB' }}>
              ...
              {['PPT / 문서', '영상 녹화', BRAND_NAME].map((col, i) => (
                <div key={col} style={{ padding: '18px 0', textAlign: 'center', fontSize: '13.5px', fontWeight: 600, color: i === 2 ? '#009B8E' : '#374151', background: i === 2 ? '#F7FFF8' : 'transparent', borderLeft: '1px solid #F3F4F6' }}>{col}</div>
              ))}
            </div>
            {[
              ...
              <div key={row.label} className="comparison-row" style={{ display: 'grid', gridTemplateColumns: '1fr repeat(3, 140px)', borderBottom: ri < 5 ? '1px solid #F3F4F6' : 'none' }}>
                ...
                {row.vals.map((val, i) => (
                  <div key={i} style={{ padding: '16px 0', textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center', background: i === 2 ? '#FAFAFE' : 'transparent', borderLeft: '1px solid #F3F4F6' }}>
                    {val === true ? (
                      <span style={{ color: '#009B8E' }}><CheckIcon size={16} color="#009B8E" /></span>
                    ) : val === false ? (
                      <XIcon size={16} />
                    ) : (
                      <span style={{ fontSize: '12.5px', color: i === 2 ? '#009B8E' : '#6B7280', fontWeight: i === 2 ? 600 : 400 }}>{val}</span>
                    )}
                  </div>
                ))}
              </div>
                ...
                <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                  {plan.features.map(f => (
                    <li key={f} style={{ display: 'flex', gap: '10px', alignItems: 'flex-start', fontSize: '13.5px', color: '#4B5563', padding: '7px 0' }}>
                      <span style={{ flexShrink: 0, marginTop: '2px' }}><CheckIcon size={14} color="#009B8E" /></span>
                      {f}
                    </li>
                  ))}
                </ul>
      ...
      <section id="faq" style={{ padding: '96px 0', background: 'white' }}>
        <div style={{ maxWidth: '1180px', margin: '0 auto', padding: '0 32px' }}>
          <span style={{ display: 'block', textAlign: 'center', fontSize: '12px', color: '#009B8E', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '14px' }}>FAQ</span>
      ...
      <section className="final-cta-section" style={{ padding: '0 0 100px', background: '#FAFAFA' }}>
        <div className="final-cta-wrap" style={{ maxWidth: '1180px', margin: '0 auto', padding: '0 32px' }}>
          <div className="final-cta-inner" style={{ background: 'linear-gradient(135deg, #102033 0%, #007C72 35%, #007C72 70%, #007C72 100%)', borderRadius: '28px', padding: '84px 56px', textAlign: 'center', color: 'white', position: 'relative', overflow: 'hidden' }}>
            ...
            {/* Ambient glow orbs */}
            <div style={{ position: 'absolute', top: '-120px', right: '-80px', width: '380px', height: '380px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(141,214,63,0.22) 0%, transparent 70%)', filter: 'blur(40px)', pointerEvents: 'none' }} />
            <div style={{ position: 'absolute', bottom: '-100px', left: '-60px', width: '320px', height: '320px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(18,184,134,0.20) 0%, transparent 70%)', filter: 'blur(40px)', pointerEvents: 'none' }} />
      ...
      <style suppressHydrationWarning>{`
        ...
        @keyframes pulse {
          0%, 100% { box-shadow: 0 0 0 6px rgba(0,155,142,0.22), 0 2px 8px rgba(0,155,142,0.5); }
          50% { box-shadow: 0 0 0 12px rgba(0,155,142,0.10), 0 2px 8px rgba(0,155,142,0.5); }
        }
        @keyframes pulse-dot {
          0%, 100% { opacity: 1; }
          50% { opacity: 0.45; }
        ...
        .record-flash-demo .capture-sweep {
          ...
          z-index: 6;
          pointer-events: none;
          background: linear-gradient(90deg, transparent 0%, rgba(255,255,255,0.02) 34%, rgba(255,255,255,0.72) 50%, rgba(141,214,63,0.22) 62%, transparent 100%);
        ...
        .record-flash-demo .capture-flash {
          ...
          border-radius: 16px;
          pointer-events: none;
          background: radial-gradient(circle, rgba(255,255,255,0.92) 0%, rgba(141,214,63,0.28) 48%, transparent 72%);
        ...
        .hero-orb-1 {
          ...
          background: radial-gradient(circle, rgba(18,184,134,0.13) 0%, transparent 70%);
          animation: orbFloat1 14s ease-in-out infinite;
        }
        .hero-orb-2 {
          top: 40px; right: -80px;
          width: 480px; height: 480px;
          background: radial-gradient(circle, rgba(0,155,142,0.10) 0%, transparent 70%);
        ...
        .simulator-step:focus-visible {
          border-color: rgba(141,214,63,0.36);
          background: rgba(255,255,255,0.06);
          outline: none;
        }
        .simulator-step.active {
          border-color: rgba(141,214,63,0.42);
          background: linear-gradient(135deg, rgba(0,155,142,0.30), rgba(18,184,134,0.18));
