  ...
  return (
    <div style={{ padding: '28px 32px', maxWidth: '720px' }}>
      ...
      <div style={{ background: 'white', border: '1px solid #E2E8F0', borderRadius: '14px', padding: '22px' }}>
        ...
        <input value={subject} onChange={e => { setSubject(e.target.value); setResult(null); }} placeholder="예: 포리 6월 업데이트 — 라이브 가이드 Beta 자동입력 출시" style={{ ...inputStyle, marginBottom: '16px' }} maxLength={200} />
        ...
        <p style={{ fontSize: '11.5px', color: '#94A3B8', margin: '8px 0 0' }}>빈 줄 = 문단 구분. 포리 브랜드 템플릿으로 감싸 발송하며, 푸터에 수신거부 안내가 자동 포함됩니다.</p>
