    ...
    <div className="auth-grid" style={{ fontFamily: "'Pretendard', 'Pretendard Variable', -apple-system, BlinkMacSystemFont, 'Segoe UI', Inter, Roboto, sans-serif" }}>
        ...
        <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', height: '100%' }}>
          ...
          <div style={{ marginTop: 'auto', paddingBottom: '8px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
              {[
                { icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polygon points="16.24 7.76 14.12 14.12 7.76 16.24 9.88 9.88 16.24 7.76"/></svg>, title: 'Live Guide Beta로 따라만 하면 끝', sub: '받는 사람은 화면 위 안내를 따라 클릭만 하면 됩니다.' },
      ...
      <section className="auth-form-panel" style={{ display: 'flex', flexDirection: 'column', padding: '36px 64px', background: 'white' }}>
        <div style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center', gap: '4px', fontSize: '13px', color: '#6B7280' }}>
          계정이 없으신가요?
          <Link href="/auth/signup" style={{ color: BRAND_COLORS.primary, fontWeight: 500, marginLeft: '4px', textDecoration: 'none' }}>회원가입</Link>
        </div>
          ...
          <form onSubmit={handleEmail}>
            ...
            <div style={{ marginBottom: '16px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
                ...
                <Link href={`/auth/forgot-password${email ? `?email=${encodeURIComponent(email)}` : ''}`} style={{ fontSize: '11.5px', color: BRAND_COLORS.primary, textDecoration: 'none' }}>비밀번호를 잊으셨나요?</Link>
              </div>
