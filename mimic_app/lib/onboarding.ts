...
export const DESKTOP_ONBOARDING_STEPS: OnboardingStep[] = [
  ...
  },
  {
    id: 'home-create',
    title: '만들기 방법을 확인해요',
    body: '여러 만들기 방법을 소개할게요. 이번 연습에서는 웹 페이지 녹화만 선택할 수 있어요.',
  ...
  },
  {
    ...
    body: '웹은 Chrome 탭, 데스크톱은 Windows 앱, 직접 작성은 빈 문서, 플레이북은 여러 자료를 묶을 때 사용해요. 다음을 누르면 웹 페이지 녹화로 자동 이동해요.',
  ...
  },
  {
    ...
    body: '웹 페이지 녹화가 이번 연습의 선택 항목이에요. 다음을 누르면 Recorder 연결 확인을 자동으로 시작해요.',
  ...
  },
  {
    ...
    body: '다음을 누르면 연결을 확인하고 안전한 Parro 연습 페이지를 자동으로 열어요. 설치가 필요하면 Recorder 화면의 안내를 따라주세요.',
