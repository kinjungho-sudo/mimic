...
- 첫 번째 클릭/첫 번째 스텝을 제목으로 쓰지 말고, 전체 단계가 끝났을 때 사용자가 달성하는 최종 목적을 작성
- "메일 클릭하기", "버튼 클릭하기", "메뉴 선택하기"처럼 한 행동만 적은 제목 금지
- 개인정보, 수량 노이즈, 긴 코드/ID는 포함 금지
- 사용자가 검색/선택/입력한 과정명·강의명·상품명처럼 최종 목적을 구체화하는 핵심 대상은 제목에 포함
- 과정명/강의명 입력 후 수강 신청을 완료하는 흐름이면 "과정명 강의 수강 신청하기" 형식으로 작성
- 좋은 예: "메일 작성 후 보내기", "인공지능(AI)전문가 1급 강의 수강 신청하기", "Slack 채널 만들기"
...
- 개인정보, 수량 노이즈, 긴 코드/ID는 포함 금지. 단, 사용자가 선택/입력한 과정명·강의명처럼 단계 목적을 설명하는 핵심 대상은 허용
