...
assert.doesNotMatch(component, /clickPulse|finishClickPulse/, 'landing demo must not render circular click waves');
assert.doesNotMatch(css, /\.clickPulse|\.finishClickPulse/, 'landing demo CSS must not retain circular click waves');
