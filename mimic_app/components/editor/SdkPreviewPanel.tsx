  ...
  return (
    <div style={{ height: '44px', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 14px', borderBottom: '1px solid #E5E7EB', background: 'white' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
        ...
        <span style={{ fontSize: '12px', fontWeight: 600, color: '#374151' }}>SDK 미리보기</span>
        <span style={{ fontSize: '10px', color: '#9CA3AF', background: '#F3F4F6', padding: '1px 6px', borderRadius: '4px' }}>실제 SDK 툴팁</span>
      </div>
      <button
        onClick={onClose}
