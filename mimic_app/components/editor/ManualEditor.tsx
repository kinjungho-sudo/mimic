        ...
        >
          {steps.length === 0 ? (
            ...
            steps.map(step => (
              ...
              >
                <div className="manual-step-width" style={{ width: '100%', maxWidth: '1032px', padding: '0 24px', boxSizing: 'border-box' }}>
                  <StepCard
                    step={step}
                    isActive={activeId === step.id}
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <img src={step.screenshotUrl} alt="" draggable={false} style={{ width: 'auto', maxWidth: '100%', maxHeight: 'calc(100vh - 320px)', height: 'auto', display: 'block', userSelect: 'none' }} />
