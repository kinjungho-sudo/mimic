    ...
    <div style={{ padding: '36px 40px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '14px', marginBottom: '24px' }}>
        {[
          ...
          { label: 'Pro 플랜', value: proCount, color: '#4F46E5', bg: '#EEF2FF' },
          { label: 'Team 플랜', value: teamCount, color: '#7C3AED', bg: '#F5F3FF' },
            ...
            {loading ? (
              ...
              <tr key={s.id} style={{ borderTop: '1px solid #F1F5F9' }}>
                ...
                <td style={{ padding: '13px 16px' }}>
                  <span style={{ padding: '3px 8px', borderRadius: '5px', fontSize: '11.5px', fontWeight: 500, background: s.plan_interested === 'pro' ? '#EEF2FF' : '#F5F3FF', color: s.plan_interested === 'pro' ? '#4F46E5' : '#7C3AED' }}>
                    {s.plan_interested}
                  </span>
                </td>
